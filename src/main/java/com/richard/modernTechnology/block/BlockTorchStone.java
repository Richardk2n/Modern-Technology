...
public class BlockTorchStone extends BlockModernTechnology{

	 private static final String __OBFID = "CL_00000325";

	    public BlockTorchStone()
	    {
	        super(Material.circuits);
	        this.setTickRandomly(true);
	        this.setCreativeTab(CreativeTabsModernTechnology.MODERNTECHNOLOGY_TAB);
			this.setBlockTextureName("BlockTorchStone");
			this.setBlockName("BlockTorchStone");
	    }
